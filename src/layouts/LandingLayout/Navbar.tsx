  ...
  return (
    <nav className="sticky top-0 z-30">
      <div className={`relative ${isShadow && "shadow-2xl"}`}>
          ...
          <div className="container max-w-8xl mx-auto">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden lg:flex lg: items-center gap-8">
                  ...
                  {NAV_LINKS.map((dataItem) => {
                    if (dataItem.children) {
                      ...
                      return (
                        ...
                        >
                          <Link to={dataItem.path || ""}>{dataItem.label}</Link>
                        </Button>
                      );
                    }
                  })}
                ...
                >
                  <img
                    src="https://app.companiesoffice.govt.nz/companies/app/ui/themes/companies/images/CO_Details_light_optimal_WEB.png"
                    alt="Company"
                  />
                </a>
              </div>
        ...
        {opened && (
          <div
            className={`absolute w-full flex lg:hidden flex-col items-center bg-primary ${
              isShadow && "shadow-2xl"
            }`}
          >
            {/* {NAV_BUTTONS.map(dataItem => (
